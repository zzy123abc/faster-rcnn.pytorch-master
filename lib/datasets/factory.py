...
from datasets.ucf24 import ucf24
...
for split in ['train', 'val']:
    name = 'ava_{}'.format(split)
    __sets[name] = (lambda split=split: ava(split))

# set up ava__<split>
for split in ['train', 'val']:
    name = 'ucf24_{}'.format(split)
    __sets[name] = (lambda split=split: ucf24(split))
